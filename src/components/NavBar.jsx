      ...
      <div className="flex-none">
        <div className="menu menu-horizontal  text-center px-1 hidden md:flex md:justify-center md:items-center space-y-3">
          <Link
            ...
            className={
              pathname === "/"
                ? "bg-green-400 text-lg text-white font-semibold  mr-5 flex gap-1 items-center justify-center p-2 rounded-md "
                : `text-lg text-gray-500 font-semibold  mr-5 flex gap-1 items-center justify-center`
            }
          >
            <IoMdHome />
            Home
